...
public class ScreenSize {
	...
	/**
	 * Coordena X para centrar la ventana Obtiene el ancho de de la pantalla y el
	 * ancho de una vetana y lo divide entre 2
	 * 
	...
	/**
	 * Coordena Y para centrar la ventana Obtiene el alto de de la pantalla y el
	 * alto de una vetana y lo divide entre 2
	 * 
