	...
	public ModificarFactura(final Factura factura) {
		...
		btnModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Factura factura = new Factura(seleccionComboBoxEmpleado(),
				// seleccionComboBoxCliente(), prodctServ, fechaActual);
				/*
				 * factura.setCliente(seleccionComboBoxCliente());
				 * factura.setEmpleado(seleccionComboBoxEmpleado());
				 * factura.setProductos(prodctServ); factura.setPrecio(null); //Deberiamos
				 * volver a calcularlo o con meter los nuevos productos vale??
