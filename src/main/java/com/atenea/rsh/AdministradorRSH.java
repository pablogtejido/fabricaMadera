...
public class AdministradorRSH {
	...
	public List<Administrador> verAdministrador() {
		...
		List<Administrador> admin = response.readEntity(new GenericType<List<Administrador>>() { // Crear una lista de
																									// clientes
		});
		return admin;
	}
	 ...
	 * @return <Code>Administrador</Code> Administrador con el id ya guardado en la
	 *         DB
	 */
