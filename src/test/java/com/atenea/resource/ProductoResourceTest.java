...
public class ProductoResourceTest {
	  ...
	  private static HttpServer server;
	    ...
	    public void Clean() {
	        System.out.println(
	                "================================================Cleaning data ...================================================");
	        List<Producto> productosBD = rsh.verProductos();
	    ...
	    public void testEliminarProducto() {
	        ...
	        for (Producto pr : productosBD) {
	            if (pr.equals(producto1)) {
	            	producto1_found = true;
	            } else if (pr.equals(producto2)) {
	            	producto2_found = true;
	            } else if (pr.equals(producto3)) {
	            	producto3_found = true;
	            } else if (pr.equals(producto4)) {
	            	producto4_found = true;
	            } else if (pr.equals(producto5)) {
	            	producto5_found = true;
	            }
	        }
