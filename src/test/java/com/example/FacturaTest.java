...
/*	 
	 ...
	 public void testGetListaProductos() {
		...
		Producto instanceProducto = new Producto(id, precio, peso, cantidad, medida, grosor, anyadido);
		pr.add(instanceProducto);
		
		List<Producto> pr2 = new ArrayList<Producto>();
		
		long idExpect = 12;
		Producto expectResult=new Producto(idExpect, precio ,peso, cantidad ,medida , grosor, anyadido);
		pr2.add(expectResult);
